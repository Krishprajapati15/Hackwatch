...
const FooterBlockItem = ({ title, items }) => {
  return (
    <div className="space-y-6 ">
      <h1 className="text-lg font-semibold text-purple-900 dark:text-gray-100">
        {title}
      </h1>
...
const FooterBlock = () => {
  return (
    <footer className="bg-pink-800 ocapacity-30% text-white dark:bg-gray-950 text-gray-700 ">
      <div className="max-w-7xl mx-auto px-0 sm:px-10 md:px-12 lg:px-5  py-20 flex flex-col lg:flex-row gap-14">
          ...
          <div className="flex-1 max-w-md">
            <form action="#" className="w-full flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="px-5 py-2.5 rounded-md outline-none flex-1 bg-purple-900 text-white"
              />
              <button className="outline-none w-full py-2.5 px-5 sm:w-max bg-blue-900 text-white rounded-md flex items-center justify-center">
                send email
              </button>
            </form>
          </div>
        </div>
        <div className="w-full text-black justify-center text-center py-3 bg-gray-100 dark:bg-gray-900 rounded-lg">
