  ...
  return (
    <section className="py-8">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
        <div className="flex md:flex-1 border-5 border-pink-700 rounded-[20px]">
          <img
            src="/public/hero.jpg"
            alt="creative agency "
            width={1000}
        ...
        <div className="md:w-1/2 space-y-12 text-gray-700 dark:text-gray-300 md:py-8">
          <h1 className="text-purple-900 dark:text-white font-bold uppercase text-3xl sm:text-3xl md:text-4xl">
            Secure & Accelerate Your CI/CD Pipelines
          </h1>
          <p className="text-gray-700 dark:text-gray-300">
            Protect your software delivery process with real-time security
            insights, automated threat detection, and best-in-class CI/CD
            security solutions. Ensure compliance, minimize vulnerabilities, and
